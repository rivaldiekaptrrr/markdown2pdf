      ...
      <div className="flex flex-col" style={{ height: '100vh', background: 'var(--bg-primary)' }}>
        ...
        >
          ...
          <div className="ml-auto flex items-center gap-2">
            {/* Creator Links */}
            <div className="flex items-center gap-1.5 mr-2 pr-2 border-r border-[var(--border)]">
              <a
                href="https://github.com/rivaldiekaptrrr"
                target="_blank"
                rel="noopener noreferrer"
                title="Built by Rivaldi Eka Putra — GitHub"
                className="p-1.5 rounded-md text-[var(--text-muted)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-tertiary)] transition-colors flex items-center justify-center"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                title="Built by Rivaldi Eka Putra — LinkedIn"
                className="p-1.5 rounded-md text-[var(--text-muted)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-tertiary)] transition-colors flex items-center justify-center"
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
